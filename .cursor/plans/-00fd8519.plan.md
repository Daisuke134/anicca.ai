<!-- 00fd8519-7bd6-4b41-8e67-892528a57b1d cf4e29cc-70d9-4cd7-9f83-cdef9b832015 -->
# 緊急バグ修正4件
...
- [ ] NotificationScheduler.swift: .caf形式の音声ファイルのみを使用するよう修正
- [ ] HabitsSectionView.swift: withAnimation(.none)を削除
- [ ] AppState.swift/WakePromptBuilder.swift: カスタム習慣IDに基づく名前取得
- [ ] VoiceSessionController.swift: Stickyモードを.wakeのみに限定