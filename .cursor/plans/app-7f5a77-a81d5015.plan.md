...
もしiPad対応を無くしたiPhoneのみにする場合

--- a/aniccaios/aniccaios.xcodeproj/project.pbxproj

+++ b/aniccaios/aniccaios.xcodeproj/project.pbxproj
...
INFOPLIST_KEY_ANICCA_PROXY_BASE_URL = "$(INFOPLIST_KEY_ANICCA_PROXY_BASE_URL)";

INFOPLIST_KEY_REVENUECAT_API_KEY = "$(INFOPLIST_KEY_REVENUECAT_API_KEY)";

INFOPLIST_KEY_REVENUECAT_ENTITLEMENT_ID = "$(INFOPLIST_KEY_REVENUECAT_ENTITLEMENT_ID)";
...
INFOPLIST_KEY_REVENUECAT_ID = "$(INFOPLIST_KEY_REVENUECAT_ID)";
