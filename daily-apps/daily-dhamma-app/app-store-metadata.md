# Daily Dharma - App Store Metadata
...
PREMIUM FEATURES
• Access to 400+ verses from the complete Dhammapada
• Unlimited Stay Present reminders
• Widget themes (coming soon)
...
## Privacy Policy URL
```
https://aniccaai.com/dailydharma/privacy
```

## Marketing URL (Optional)
```
https://aniccaai.com/dailydharma
```

---

## Screenshot Text (for Sleek)
...
### Screenshot 3 - Stay Present Notifications
