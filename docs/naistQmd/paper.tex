...
　統計解析は，macOS 26.0.1上で，R version 4.3.1
(2023-06-16)を用いて実施された。
...
\caption{\label{tab:apa-correlation}Big Five因子の平均・標準偏差と相関}
...
\caption{\label{tab:apa-regression}重回帰分析結果}
\fontsize{10}{12}\selectfont
\begin{threeparttable}
...
\caption{\label{tab:apa-anova}分散分析結果}
\fontsize{10}{12}\selectfont
\begin{threeparttable}
...
gender & 156.25 & 1 & 156.25 & 1.88 & .177 & .04 & {}[NA, NA]\\
alcohol & 102.08 & 2 & 51.04 & 0.61 & .546 & .03 & {}[NA, NA]\\
gender x alcohol & 1978.12 & 2 & 989.06 & 11.91 & <.001 & .36 & {}[NA, NA]\\
