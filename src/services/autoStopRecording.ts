 ...
 * 自動停止機能付き録音サービス
 * 
 * 録音を開始し、1.5秒間の無音を検出したら自動的に録音を停止
 * Enterキー不要の完全自動録音
 */
export class AutoStopRecording {
  ...
  constructor() {
    console.log('🎙️ Auto-stop Recording Service initialized');
  }
   ...
   */
  async startRecordingWithAutoStop(): Promise<Buffer> {
    if (this.isRecording) {
